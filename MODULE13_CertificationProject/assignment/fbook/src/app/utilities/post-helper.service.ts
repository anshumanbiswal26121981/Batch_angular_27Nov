...
export class PostHelperService {
  ...
  calculatePostTimers(filteredPosts: any): Post[] {
    filteredPosts.forEach((element: { postTimer: string; createdDate: any; }) => {
  ...
  private loadUserIconForPosts(filteredPosts: any, userId: String): Observable<any> {
    return new Observable(observer => {
      filteredPosts.forEach((postElement: { isMyPost: boolean; userId: String; userPhotoId: String; userIcon: any; }) => {
  ...
  private loadPostImages(mappedPosts: any): Observable<any> {
    return new Observable(observer => {
      mappedPosts.forEach((postElement: { postImageId: String; isPostImage: boolean; postImage: any; }) => {
